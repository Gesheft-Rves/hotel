...
@EntityScan(basePackages = {"com.rves.pojo"}) //specifies the packages to look for JPA Entities.
@EnableJpaRepositories(basePackages = {"com.rves.repositories"}) //enables the auto configuration of Spring Data JPA.
